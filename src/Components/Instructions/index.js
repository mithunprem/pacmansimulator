        ...
        <div className="instructions ml-3 mb-3 mr-3">
          ...
          <Collapse className="mt-2 instructions-text text-muted" isOpen={showInstructions}>
            <Card>
              <CardBody>
                <p className="pb-2">
                  A Pacman, waiting for your command to move around on a 5 x 5
                ...
                <ListGroup>
                  <Li>
                    <b>PLACE X,Y,DIRECTION</b> - To place the pacman on the table
                    at the position (X,Y) facing the DIRECTION specified.
                  </Li>
                  <Li>
                    <b>MOVE</b> - To move the pacman by one step in the direction
                    it is currently facing.
                  </Li>
                  <Li>
                    <b>LEFT</b> - To rotate the pacman counter clockwise by 90
                    degress without changing it's position.
                  </Li>
                  <Li>
                    <b>RIGHT</b> - To rotate the pacman clockwise by 90 degress
                    without changing it's position.
                  </Li>
                  <Li>
                    <b>REPORT</b> - To get the current X,Y and DIRECTION of the pacman.
                  </Li>
                  <Li>
                    <b>RESET</b> - To reset the pacman's position and take it off the table.
                  </Li>
                </ListGroup>
                <p className="mt-3">Notes :</p>
                  <ul className="pl-3 m-0">
                    ...
                    <li>
                      The first valid command to the pacman is a PLACE command.
                      The application will discard all commands in the sequence
                      until a valid PLACE command has been executed.
                    </li>
                    <li>
                      A pacman that is not on the table will ignore the MOVE,
